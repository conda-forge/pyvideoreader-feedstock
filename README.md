...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyvideoreader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15174&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyvideoreader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyvideoreader` can be installed with:

```
conda install pyvideoreader
```

It is possible to list all of the versions of `pyvideoreader` available on your platform with:
